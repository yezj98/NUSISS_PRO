...
class PaymentResourceIT {
    ...
    public static Payment createEntity(EntityManager em) {
        Payment payment = new Payment().userID(DEFAULT_USER_ID).amount(DEFAULT_AMOUNT).status(DEFAULT_STATUS);
        return payment;
    }
    ...
    public static Payment createUpdatedEntity(EntityManager em) {
        Payment payment = new Payment().userID(UPDATED_USER_ID).amount(UPDATED_AMOUNT).status(UPDATED_STATUS);
        return payment;
    }
    ...
    void putExistingPayment() throws Exception {
        ...
        updatedPayment.userID(UPDATED_USER_ID).amount(UPDATED_AMOUNT).status(UPDATED_STATUS);
    ...
    void fullUpdatePaymentWithPatch() throws Exception {
        ...
        partialUpdatedPayment.userID(UPDATED_USER_ID).amount(UPDATED_AMOUNT).status(UPDATED_STATUS);
